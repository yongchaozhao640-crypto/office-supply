...
import { getPurchaseList, addPurchase, deletePurchase, batchDeletePurchase } from '../api/purchase'
...
export default {
  ...
  setup() {
    ...
    return { tableData, selectedRows, pageNum, pageSize, total, filterYear, filterMonth, searchPurchaser, searchSupply, dialogVisible, form, years, supplyOptions, load, handleSelectionChange, loadSupplies, onSupplySelect, formatDate, handleDelete, handleBatchDelete, submit }
  }
}
</script>
